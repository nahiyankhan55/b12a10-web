...
const ProfilePage = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-5 items-center mt-5 sm:mt-10">
      ...
      <div className="flex md:flex-row flex-col gap-5 w-full justify-start items-start">
        ...
        <div className=" max-w-lg w-full rounded-lg flex flex-col gap-6 px-5 mx-auto">
          <form
            onSubmit={updateName}
